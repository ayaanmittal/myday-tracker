-- STEP 1: Process all approved leave requests into leaves table
-- This is the first logical step to fix the issue
...
-- Step 5: Process approved leave requests into leaves table
-- This is the core logic to create leave records for each day
