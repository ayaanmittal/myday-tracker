-- FIX DAILY RATE CALCULATION
-- Daily rate should be calculated based on 30 days (total days in month)
-- since office holidays and Sundays are paid

-- Step 1: Drop and recreate the function with correct daily rate calculation
...
SELECT 
  'Testing Corrected Daily Rate Calculation' as info,
  *
...
-- Step 3: Show expected daily rates for October 2025 (31 days)
SELECT 
  'Expected Daily Rates for October 2025 (31 days)' as info,
  'Dolly (₹5,000): ₹161.29' as dolly_rate,
  'Isha (₹5,000): ₹161.29' as isha_rate,
  'Sakshi (₹10,000): ₹322.58' as sakshi_rate,
  'Arjan (₹14,000): ₹451.61' as arjan_rate;
