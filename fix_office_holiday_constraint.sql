-- Fix office holiday constraint and function
-- Run this in Supabase SQL Editor

-- Step 1: Update the manual_status constraint to allow 'Office Holiday'
...
-- Step 2: Create the mark_office_holiday_range function
