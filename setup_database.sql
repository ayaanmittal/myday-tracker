...
-- 1. Add designation column to profiles table
...
-- 3. Create extra_work_logs table
...
-- 7. Create RLS policies for extra_work_logs table
...
DROP POLICY IF EXISTS "Admins and managers can update all extra work logs" ON public.extra_work_logs;
...
DROP POLICY IF EXISTS "Admins and managers can delete all extra work logs" ON public.extra_work_logs;
