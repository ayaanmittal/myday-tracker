-- CREATE MISSING LEAVES SCRIPT
-- This will create leave records from approved leave requests
...
-- Step 3: Create leave records from approved leave requests
...
-- Step 4: Check results after creating leave records
...
-- Step 5: Show detailed leaves created
