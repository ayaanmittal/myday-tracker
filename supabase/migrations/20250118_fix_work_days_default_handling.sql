-- Fix work days default handling for employees without configuration
-- This migration ensures all employees have proper work days configuration
...
-- Step 2: Fix the get_employee_work_days function to handle edge cases better
DROP FUNCTION IF EXISTS public.get_employee_work_days(UUID);
...
-- Step 3: Fix the get_employee_work_days_summary function
DROP FUNCTION IF EXISTS public.get_employee_work_days_summary(UUID, DATE);
...
-- Step 4: Fix the calculate_employee_leave_deductions function
