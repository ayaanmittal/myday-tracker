-- Migration: Auto Default Checkout Function
-- This migration creates functions to automatically set default checkout time to 5 PM
-- for employees who checked in but didn't check out by the end of the day
