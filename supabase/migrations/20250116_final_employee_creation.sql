-- Final employee creation function with admin-set password
-- This creates both auth user and profile for immediate login
...
BEGIN
  ...
  -- Create the user in auth.users with minimal required fields
