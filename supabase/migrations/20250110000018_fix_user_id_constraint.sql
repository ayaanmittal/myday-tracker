-- Fix user_id constraint issue in leave_balances table

-- First, let's ensure the user_id column is properly set up
DO $$ 
BEGIN
...
-- Update the refresh function to ensure user_id is always set
...
BEGIN
        ...
        BEGIN
            ...
            IF employee_record.is_paid_leave_eligible THEN
                ...
                LOOP
                    ...
                    -- Insert the balance record with explicit user_id
    ...
    SELECT json_build_object(
        ...
        'message', 'Leave balances refreshed successfully with proper user_id mapping'
    ) INTO result;
