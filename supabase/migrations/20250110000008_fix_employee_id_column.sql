-- Fix the employee_id column issue in leave_balances table

-- Check if the column exists and add it if it doesn't
DO $$ 
BEGIN
    -- Check if employee_id column exists in leave_balances table
    IF NOT EXISTS (
        SELECT 1 
...
-- Update the refresh function to use the correct column name
...
-- Update the get_employee_leave_summary function
...
-- Update the update_leave_usage function
