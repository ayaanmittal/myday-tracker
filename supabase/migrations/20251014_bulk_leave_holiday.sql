-- Bulk holiday/leave processing for selected employees over a date range
-- Marks days as not absent by setting manual_status = 'leave_granted' and status = 'completed'
