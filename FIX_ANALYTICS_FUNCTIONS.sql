...
-- This script fixes the payroll analytics and leave deductions functions
...
-- Step 3: Create function to get leave deductions analytics
...
-- Step 10: Check if we have any leaves data
SELECT 
  ...
  COUNT(*) FILTER (WHERE is_office_holiday = true) as office_holidays
FROM public.leaves;
