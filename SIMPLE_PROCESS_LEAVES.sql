-- SIMPLE PROCESS LEAVES SCRIPT
-- This will directly process approved leave requests into the leaves table
...
-- Step 3: Process approved leave requests - SIMPLE APPROACH
