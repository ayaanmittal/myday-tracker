-- COMPLETE LEAVE PROCESSING SOLUTION
-- This script will fix the issue where all employees show 0 unpaid days
...
-- Step 5: Process approved leave requests
...
SELECT 'Step 7: Results after processing' as step;
SELECT 
...
SELECT 'Step 8: Detailed leaves created' as step;
SELECT 
  p.name,
  l.leave_date,
  l.leave_type_name,
...
SELECT 'Step 9: Unpaid leave calculation test' as step;
SELECT 
  p.name,
...
SELECT 'Step 10: Complete leave deduction calculation' as step;
SELECT 
  p.name,
  es.base_salary,
...
-- Step 11: Check work days configuration
SELECT 'Step 11: Check work days configuration' as step;
SELECT 
  p.name,
  ewd.monday,
  ewd.tuesday,
...
-- Step 12: Fix missing work days configuration
