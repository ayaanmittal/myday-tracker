...
-- This script drops all existing functions and recreates them with correct column references
...
-- Step 2: Recreate refresh_employee_leave_balances function
...
-- Step 3: Recreate auto_calculate_used_days function
...
-- Step 4: Recreate leave_rollover function
...
-- Step 5: Recreate auto_update_balances_trigger function
...
-- Step 6: Recreate fix_user_id_mapping function
...
-- Step 7: Recreate fix_interval_comparison function
...
-- Step 8: Recreate fix_function_types function
...
-- Step 9: Recreate fix_employee_id_column function
...
-- Step 10: Recreate fix_user_id_constraint function
