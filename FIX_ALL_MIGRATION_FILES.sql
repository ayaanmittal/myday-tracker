...
-- This script updates all migration files to use employee_category_id instead of employee_category

-- Step 1: Drop all existing functions that might have been created by migrations
...
-- Step 2: Create the correct refresh_employee_leave_balances function
...
-- Step 3: Create the correct auto_calculate_used_days function
...
-- Step 4: Create the correct leave_rollover function
...
-- Step 5: Create the correct auto_update_balances_trigger function
...
-- Step 6: Create the correct fix_user_id_mapping function
...
-- Step 7: Create the correct fix_interval_comparison function
...
-- Step 8: Create the correct fix_function_types function
...
-- Step 9: Create the correct fix_employee_id_column function
...
-- Step 10: Create the correct fix_user_id_constraint function
...
GRANT EXECUTE ON FUNCTION auto_calculate_used_days() TO authenticated;
GRANT EXECUTE ON FUNCTION leave_rollover() TO authenticated;
GRANT EXECUTE ON FUNCTION auto_update_balances_trigger() TO authenticated;
GRANT EXECUTE ON FUNCTION fix_user_id_mapping() TO authenticated;
GRANT EXECUTE ON FUNCTION fix_interval_comparison() TO authenticated;
GRANT EXECUTE ON FUNCTION fix_function_types() TO authenticated;
GRANT EXECUTE ON FUNCTION fix_employee_id_column() TO authenticated;
GRANT EXECUTE ON FUNCTION fix_user_id_constraint() TO authenticated;

-- Step 12: Verify the fix
SELECT 'All functions recreated successfully with correct column references!' as result;
