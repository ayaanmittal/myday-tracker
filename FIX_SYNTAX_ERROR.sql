-- Fix the syntax error by properly handling constraint creation
-- This will resolve the "syntax error at or near NOT" issue
...
BEGIN
  ...
  BEGIN
    ...
    ADD CONSTRAINT ux_employee_salaries_user_effective 
...
-- 2. Now recreate the RPC functions
...
-- 3. Create the get_employee_salary_summary function
...
-- 4. Create the get_employee_leaves_with_salary_deductions function
...
-- 5. Create the get_employee_salary_payment function
