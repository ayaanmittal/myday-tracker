-- FIX LEAVE DEDUCTIONS PREVIEW CALCULATION
-- This script fixes the calculate_employee_leave_deductions function to properly calculate unpaid days

-- Step 1: Check current function and data
SELECT 
...
WHERE routine_schema = 'public' 
  AND routine_name LIKE '%calculate_employee_leave_deductions%'
ORDER BY routine_name;

-- Step 2: Check sample data in leaves table
SELECT 
  'Sample Leaves Data' as info,
...
-- Step 4: Create a corrected and simplified function
...
-- Step 5: Test the function with sample employees
SELECT 
